    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        ...
        if (request.getContentType().equals(MediaType.APPLICATION_JSON_VALUE)) {
            ...
            try {
                ...
                // 获取记住我参数
                String remember = user.get(MyPersistentTokenBasedRememberMeServices.DEFAULT_PARAMETER);
                if (!ObjectUtils.isEmpty(remember)) {
                    request.setAttribute(MyPersistentTokenBasedRememberMeServices.DEFAULT_PARAMETER, remember);
                }
